...
import { AddIcon, ArrowLeftIcon, ArrowRightIcon, CalendarIcon, ChevronDownIcon, EditIcon, HamburgerIcon, ViewIcon } from "@chakra-ui/icons";
import { Flex, Grid, GridItem, Heading, List, ListIcon, ListItem, Spacer } from '@chakra-ui/react'
  ...
  <div id={sidebar ? '' : 'sidebr'}>
    ...
    <List color={'white'} fontSize={"1.2em"} spacing={4}>
      ...
      <>
        ...
        <ListItem id="ListItemSidbar" cursor="pointer">
